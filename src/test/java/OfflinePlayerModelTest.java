...
public class OfflinePlayerModelTest {
    ...
    public void toTag_and_fromTag_roundtrip_preservesAllFields() {
        ...
        OfflinePlayerModel original = new OfflinePlayerModel(id, player, actions, x, y, z);
        ...
        assertArrayEquals(original.getActions(), restored.getActions(), "actions should roundtrip");
    ...
    public void fromTag_handlesEmptyActionsList() {
        ...
        OfflinePlayerModel original = new OfflinePlayerModel(id, player, actions, 0.0, 0.0, 0.0);
        ...
        assertEquals(0, restored.getActions().length, "actions array should be empty after fromTag");
    }
}
