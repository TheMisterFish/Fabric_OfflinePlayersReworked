...
public class Config extends MidnightConfig {
    ...
    @Entry(category = "text") public static List<String> availableOptions = List.of("attack", "place", "use", "crouch", "jump", "eat", "drop_item", "drop_stack", "move_forward", "move_backwards", "disconnect");
